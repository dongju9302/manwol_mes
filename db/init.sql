...
\restrict VrKYfdRoUISdsIlXOpgKuTWWKa4KzITftqxTivg6VHpHZfxuJEUTyvxm0vgJOaF
...
CREATE TABLE public.post_likes (
    ...
    created_at timestamp without time zone DEFAULT now(),
    CONSTRAINT post_likes_type_check CHECK (((type)::text = ANY ((ARRAY['like'::character varying, 'dislike'::character varying])::text[])))
);
...
CREATE TABLE public.users (
    ...
    is_deleted boolean DEFAULT false NOT NULL,
    deleted_at timestamp without time zone,
    CONSTRAINT users_role_check CHECK (((role)::text = ANY ((ARRAY['master'::character varying, 'admin'::character varying, 'user'::character varying])::text[])))
);
...
\unrestrict VrKYfdRoUISdsIlXOpgKuTWWKa4KzITftqxTivg6VHpHZfxuJEUTyvxm0vgJOaF
